...
export default {
  ...
  methods: {
    init: function () {
      ...
      this.defaultCamera.position.x = -0.1547718783615504;
      this.defaultCamera.position.y = 3.161055798044883;
      this.defaultCamera.position.z = 8.77404890371717;
      ...
      gltf_loader.load("/models/电子楼.glb", function (gltf) {
        ...
        that.defaultCamera.lookAt(center);

        //a bug of threejs , see https://discourse.threejs.org/t/ambient-light-and-gltf-models-not-working-results-in-black-model/748/3
        scene.traverse((o) => {
          if (o.isMesh) {
      ...
      const light = new DirectionalLight(0xffffff, 0.8 * Math.PI);
